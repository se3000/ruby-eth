describe Ethereum::Utils, type: :model do
  describe "#int_to_base256" do
    ...
    let(:bin) { Ethereum::Utils.hex_to_bin hex }
    let(:int) { Ethereum::Utils.base256_to_int bin }

    it "gets the same result back" do
      base256 = Ethereum::Utils.int_to_base256 int
