describe Ethereum::Tx::Utils, type: :model do
  describe "#int_to_base256" do
    ...
    let(:bin) { Ethereum::Tx::Utils.hex_to_bin hex }
    let(:int) { Ethereum::Tx::Utils.base256_to_int bin }

    it "gets the same result back" do
      base256 = Ethereum::Tx::Utils.int_to_base256 int
